...
public class H3UtilTest {
    ...
    public void latLngToCellIsStable() {
        ...
        long cell1 = H3Util.latLngToCell(lat, lon, 8);
        long cell2 = H3Util.latLngToCell(lat, lon, 8);
    ...
    public void gridDiskNeighborsCountForK1() {
        double lat = 37.775938728915946;
        double lon = -122.41795063018799;
        long cell = H3Util.latLngToCell(lat, lon, 8);
        List<Long> disk = H3Util.gridDisk(cell, 1);
